...
# 下载源码
cd /opt && git clone https://ghproxy.com/https://github.com/key-networks/ztncui.git
cd /opt && git clone https://ghproxy.com/https://github.com/zerotier/ZeroTierOne.git
