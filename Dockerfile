...
RUN sed -i 's/dl-cdn.alpinelinux.org/mirrors.tuna.tsinghua.edu.cn/g' /etc/apk/repositories \
    ...
    && mkdir /app -p &&  cd /app && git clone https://ghproxy.markxu.online/https://github.com/key-networks/ztncui.git\
    && cd /app/ztncui/src \
...
RUN cd /app && git clone -v https://ghproxy.markxu.online/https://github.com/zerotier/ZeroTierOne.git --depth 1\
